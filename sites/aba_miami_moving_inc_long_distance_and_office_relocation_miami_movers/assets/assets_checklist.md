# Assets Needed for ABA Miami Moving Inc (long distance and office relocation, Miami movers)

## Required Images
- [ ] Logo (PNG, transparent background, min 200x200px)
- [ ] Hero background image (1920x1080px, high quality photo related to moving company)
