# Assets Needed for Landscape Design Phoenix, Landscaping Architect | Unwind Landscapes

## Required Images
- [ ] Logo (PNG, transparent background, min 200x200px)
- [ ] Hero background image (1920x1080px, high quality photo related to landscaping)
